                      ...
                      <div className="col-lg-6 col-12 px-5 py-2 mx-auto">
                          <div className='px-4 py-5' style={{fontSize:"23px"}} >
                              <div className='card py-3 px-5 bg_color' >
                                <label className='text_workflow'><span className=''><MdOutlineSecurity /></span><span className='ps-3'>Trademark & IP</span></label>
                              </div>
                              <div className='card mt-4 py-3 px-5' style={{ background: "#FEB444"}} >
                                <label className='text_workflow'><span className='fs-4'><MdBusinessCenter /></span><span className='ps-3'>Manage Business </span></label>
                              </div>
                              <div className='card mt-4 py-3 px-5 bg_color' >
                                <label className='text_workflow'> <span className='fs-4'><TbReceiptTax /></span><span className='ps-3'>Tax & Accounting </span></label>
                              </div>
                              <div className='card mt-4 py-3 px-5'  style={{ background: "#FEB444" }}>
                                <label className='text_workflow'> <span className='fs-4'><FaArrowRightArrowLeft /></span><span className='ps-3'>Import Export </span></label>
                              </div>
                              <div className='card mt-4 py-3 px-5 bg_color' >
                                <label className='text_workflow'> <span className='fs-4'><MdOutlineSecurity /></span><span className='ps-3'>GeM Services </span></label>
                              </div>
                              <div className='card mt-4 py-3 px-5' style={{ background: "#FEB444" }}> 
